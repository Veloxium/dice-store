...
const Contact = () => {
  ...
  return (
    <div class="flex flex-col lg:flex-row justify-center lg:gap-6 max-h-full  min-h-screen secondary-only ">
      <form class="lg:h-[560px] px-10 primary lg:rounded-xl lg:mt-24 py-4 pt-10 lg:pt-0">
        ...
        <div className="flex">
          <div className="w-full md:w-1/2  md:mb-0">
            <label
              className="block  tracking-wide text-white text-xs sm:text-lg font-bold mb-2"
              for="grid-first-name"
            >
              First Name
            </label>
        ...
        <div className="mb-4">
          <label
            className="block text-white text-sm sm:text-lg font-bold mb-2"
            for="Gmail"
          >
            Gmail
          </label>
        ...
        <div className="flex items-center justify-between">
          <button
            className="secondary text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
            type="button"
          >
            Submit
          </button>
      ...
      <div className=" bg-slate-50 lg:h-[560px] lg:shadow-lg sm:rounded-xl sm:mt-24 px-8 lg:w-[400px]">
        <div className=" pt-16">
          ...
          <div className="mt-4 pb-4 w-1/2 lg:mt-6">
            <div className="flex flex-col lg:mt-4">
              <div className="flex items-center gap-1 text-sm sm:text-base ">
                Jl.Padjajaran No.23, Mataram. 008856 Indonesia
              </div>
            </div>
          </div>
          <div className="flex flex-col items-start text-sm sm:text-base pt-6">
            <p>Call Us : +62 821-1213-9440</p>
            <p>We Are Open from Monday - Saturday:</p>
            <p>9.00 AM - 6.00 PM</p>
          </div>
        </div>
